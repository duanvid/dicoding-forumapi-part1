...
exports.up = (pgm) => {
    ...
    pgm.addConstraint(
        'comments', 'fk_comments.thread_id_to_threads.id', 'FOREIGN KEY(thread_id) REFERENCES threads(id) ON DELETE CASCADE'
    );
    pgm.addConstraint(
        'threads', 'fk_threads.owner_to_users.id', 'FOREIGN KEY(owner) REFERENCES users(id) ON DELETE CASCADE'
    );
    pgm.addConstraint(
        'comments', 'fk_comments.owner_to_users.id', 'FOREIGN KEY(owner) REFERENCES users(id) ON DELETE CASCADE'
    )
};
